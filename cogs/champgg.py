...
class Champgg:
    ...
    def __init__(self, bot):
        ...
        self.people = {'logan': 'warwick','theo': 'shaco','justin': 'jhin','minseong': 'ahri','james': 'caitlyn','david': 'darius', 'jp': 'yorick', 'mark': 'nidalee','frank': 'ekko','corey': 'khazix', 'amit': 'zed', 'kevin': 'akali', 'devon': 'shaco', 'vinh': 'riven', 'andrew':'katarina', 'nigger': 'urgot', 'leo': 'yasuo', 'bill': 'janna', 'jihad':'ziggs'}
